...
public class SapXepSanPham {
    ...
    public static void sortByName(){
        Collections.sort(
                sanPhams,Comparator.comparing(SanPham::getName));
    }
    public static void sortByPrice(){
        Collections.sort(
                sanPhams, Comparator.comparing(SanPham::getPrice));
    }

    public static void sortByDate(){
        Collections.sort(
                sanPhams, Comparator.comparing(SanPham::getDate));
    }

    public static void sortByPriceAndDate(){
        Comparator<SanPham> priceDateComparator =
                Comparator.comparing(SanPham::getPrice)
                        .thenComparing(SanPham::getDate);
